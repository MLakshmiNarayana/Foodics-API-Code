...
namespace Foodicsposting.Classess
{
    internal class ClsComm
    {
        public static string SqlConnectionString()
        {
            ...
            return "Data Source=" + SQLServerName() + ";Initial Catalog=" + g_CompCode + ";" + "UId=" + SQLLoginID() + ";" + "Pwd=" + SQLPW() + ";";// + "Multipleconnection="+ Multipleconnection()+ ";";
        }
        ...
        public static string Integration_time() {

            return RegValue(Microsoft.Win32.RegistryHive.Users, ".DEFAULT\\Software\\FocusExternalModule", "Integration_time", "");
        }
    }
}
